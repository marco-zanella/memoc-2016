 ...
 */
#ifndef SOLVER_GREEDY_H_
#define SOLVER_GREEDY_H_
 ...
 * Solution is generated selecting, at each step, the closest node.
 *
...
class Greedy: public Solver {
 public:
     ...
     * Solution is build selecting the closest node at each step.
