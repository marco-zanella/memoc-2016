 ...
 */
#ifndef GENERATOR_UNIFORM_H_
#define GENERATOR_UNIFORM_H_
...
class Uniform: public Generator {
 public:
     ...
     */
    explicit Uniform(const Perturbator &perturbator);
     ...
     * Points are uniformly distributed on the panel
