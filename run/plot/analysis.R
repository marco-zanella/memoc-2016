#-----------------------------------------------------------------------
# Computes statistics about Random solver
data <- read.table("random.dat", header=F)
...
write.table(df, file="random_mean.dat", row.names=F)



#-----------------------------------------------------------------------
# Computes statistics about CPLEX solver
...
#-----------------------------------------------------------------------
# Computes statistics about Genetic Algorithm solver
